...
describe command("su spark -l -c \"/srv/spark/bin/spark-submit --class org.apache.spark.examples.SparkPi --master yarn --deploy-mode cluster --executor-memory 1G --num-executors 1 /srv/spark/lib/spark-examples-1.5.2-hadoop2.4.0.jar  1000\"") do
