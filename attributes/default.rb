...
default['hadoop_spark']['snowflake-jdbc']['url']        = "https://repo1.maven.org/maven2/net/snowflake/snowflake-jdbc/#{node['hadoop_spark']['snowflake-jdbc_version']}/snowflake-jdbc-#{node['hadoop_spark']['snowflake-jdbc_version']}.jar"
default['hadoop_spark']['spark-snowflake']['url']       = "https://search.maven.org/remotecontent?filepath=net/snowflake/spark-snowflake_#{node['hadoop_spark']['spark-snowflake_artifactID']}/#{node['hadoop_spark']['spark-snowflake_version']}/spark-snowflake_#{node['hadoop_spark']['spark-snowflake_artifactID']}-#{node['hadoop_spark']['spark-snowflake_version']}.jar"
