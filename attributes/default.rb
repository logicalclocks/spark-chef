...
default['hadoop_spark']['version']                              = "3.1.1.4"
...
default['hadoop_spark']['hsfs']['version']                  = "#{node['install']['version']}-RC4"
...
default['hadoop_spark']['hsfs']['utils']['version']         = "#{node['install']['version']}-RC4"
