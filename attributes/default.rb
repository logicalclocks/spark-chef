...
default['hadoop_spark']['version']                              = "3.1.1.5"
...
default['hadoop_spark']['spark_sql_kafka_version']              = "#{node['scala']['version']}-3.1.1"
...
default['hadoop_spark']['hsfs']['rc_version']		     = "RC4"
...
# Hudi Dependencies
#
default['hadoop_spark']['hudi_spark_bundle_url']                  = "#{node['download_url']}/hudi/#{node['hive2']['hudi_version']}/hudi-spark3.1-bundle_#{node['scala']['version']}-#{node['hive2']['hudi_version']}.jar"
...
# Delta
#
default['hadoop_spark']['databricks_delta_version']         = "#{node['scala']['version']}-1.0.1"
