...
describe command("su spark -l -c \"/srv/spark/bin/spark-submit --class org.apache.spark.examples.SparkPi --master yarn-cluster  --num-executors 1 --driver-memory 512m --executor-memory 256m --executor-cores 1 --queue default /srv/spark/lib/spark-examples*.jar 2\"") do
