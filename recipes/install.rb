...
files= "parquet-encoding-#{node['hadoop_spark']['parquet_version']}.jar, parquet-common-#{node['hadoop_spark']['parquet_version']}.jar, parquet-hadoop-#{node['hadoop_spark']['parquet_version']}.jar, parquet-jackson-#{node['hadoop_spark']['parquet_version']}.jar, parquet-column-#{node['hadoop_spark']['parquet_version']}.jar, parquet-format-#{node['hadoop_spark']['parquet_format_version']}.jar, spark-hive_#{node['scala']['version']}-#{node['hadoop_spark']['version']}.jar,snappy-0.4.jar, spark-avro_#{node['hadoop_spark']['spark_avro_version']}.jar, spark-tensorflow-connector_#{node['hadoop_spark']['tf_spark_connector_version']}.jar"
